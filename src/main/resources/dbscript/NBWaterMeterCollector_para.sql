...
if (not exists (select name from sysobjects where name='nb_water_meter'))
	begin
		...
		(
			...
			default_key			 					varchar(32)	not null default 'asdfghj34dfgtert',				/*默认密钥*/
			backup_key			 					varchar(32)	not null default 'asdfghj34dfgtert',				/*备用密钥*/
			key_no 										int				  not null default 	-1,												/*母钥编号*/
			...
			valve_status							tinyint				null,				/*阀门最新状态 0：开阀  1：关阀*/
